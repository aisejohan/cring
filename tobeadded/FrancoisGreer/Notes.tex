...
\bprop Let $\phi:A\rightarrow B$ be a map of commutative rings such that $B$ is finitely generated as an $A$-module.  Then $\Phi$ is a closed map.\eprop
...
\bprop Let $X$ be a space.  Then we have $\Hom_{spaces}(\Spec R,X)=X(R)$. \eprop
...
\bprop (Cayley-Hamilton Theorem) \eprop
