...
\num{Problem 7.} Because $R$ is Noetherian, $I$ is finitely
generated. Thus, there are nilpotent elements $a_1,\ldots,a_r\in I$ such
that $I=(a_1,\ldots,a_r)$. Let $n_i$ be such that $a_i^{n_i}=0$. Then because
$I^{n_1+\cdots+n_r}$ is generated by the products of $n_1+\cd
