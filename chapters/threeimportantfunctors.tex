...
\begin{lemma}[Nakayama's lemma] If $R$ is a local ring with maximal ideal
...
\add{the explanation via the small object argument}
...
Conversely, given a function of two variables satisfying the above properties,
...
General nonsense says that given $M,N$, an universal $R$-bilinear map $M \times N \to P$ is
...
\begin{proof}[Proof of Proposition~\ref{tensorexists}] We will simply give a presentation of the tensor product by
...
we see that $1 \otimes 1$ spans $\mathbb{Z} / (10) \otimes \mathbb{Z} / (12)$ and this tensor
...
so the cyclic group $\mathbb{Z} / (10) \otimes \mathbb{Z} / (12)$ has order dividing both
$10$ and $12$. This means that the cyclic group has order dividing 
$\gcd(10, 12) = 2$.

To show that the order of $\mathbb{Z} / (10) \otimes \mathbb{Z} / (12)$, define a bilinear map
...
$f: \mathbb{Z} / (10) \otimes \mathbb{Z} / (12) \to \mathbb{Z} / (2)$ making the diagram
\[ 
\xymatrix{
...
$\mathbb{Z} / (10) \otimes \mathbb{Z} / (12)$ has size at least two. This allows us to
