...
is a natural morphism of diagrams \eqref{hugediag}, so $\mathbf{M}$ is a
functor.
...
morphism, it can be extended to $R \to \mathbf{M}(N)$. The idea will now be to
...
\mathbf{M}_{\omega'}(N)$. 
It is clear that the $\mathbf{M}_{\omega}$ form an inductive system over
