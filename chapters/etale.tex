...
We also want a slightly different characterization of an \'etale morphism.
\begin{theorem} 
...
We might not necessarily expect global properties to be preserved (e.g. an
...
Note that this \emph{fails} if $Y$ is not normal.
\begin{example} 
